...
<table width="1000" height="30"   border="5" bordercolor="#d2c9ba" align="center" cellpadding="1" cellspacing="1" bgcolor="#eae3d9">
  <tr align="center" height="40">
    <td width="250" class="style1">用户名</td>
    <td width="250" class="style1">用户Email</td>
    <td width="250" class="style1">注册时间 </td>
    <td width="250" class="style1">操作</td>
  </tr>
<?php  
$query="select * from tb_cuser";
$result=mysql_query($query);
...
?>
  <tr height="70">
    <td width="250" align="center" class="style1"><?php echo $myrow['username'];?></td>
    <td width="250" align="center" class="style1"><?php echo $myrow['email'];?></td>
    <td width="250" align="center" class="style1"><?php echo $myrow['usertime'];?></td>
    <td height="50" width="250" align="center" valign="middle" class="style1">&nbsp;<a href="aduser_ok.php?username=<?php echo $myrow['username'];?>">删除</a></td>
  </tr>
