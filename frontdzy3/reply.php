  ...
  <tr>
    <td width="1000"><table width="1000" height="430"  border="5" bordercolor="#d2c9ba" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="300" align="center" valign="center"><table width="88%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
		  <?php 
		...
		<form name="myform" method="post" action="reply_ok.php" enctype="multipart/form-data"  onSubmit="javascript:return reply_check();">
     <?php  
             $query1="select * from tb_czqtz where tz_id='".$_GET['tz_id']."'";
             $result1=mysql_query($query1); 
             $row=mysql_fetch_array($result1);
    ?>
                    <tr>
                <td height="30">&nbsp;</td>
              <td class="style2" align="left">回复主题:<?php echo $_GET['title'];?></td>
            </tr>
              <tr>
                <td height="235" align="center" class="style2">内容:&nbsp;</td>
                <td align="left" valign="middle" ><textarea name="hfnr" cols="47" rows="10" wrap="PHYSICAL" id="hfnr"></textarea>                  
				  <input name="tz_id" type="hidden" id="tz_id" value="<?php echo $row['tz_id'];?>">
				  <input name="title" type="hidden" id="title" value="<?php echo $_GET['title'];?>">  </td>
             </tr>
              <tr>
                <td height="35" align="center">&nbsp;</td>
                <td align="left"><input name="reply" type="submit" id="reply" value="提交信息">
                <input type="reset" name="Submit2" value="重置信息"></td>
              </tr>
		      </form>
       </table>		</td>
      </tr>
