...
<table width="1000" height="30"   border="5" bordercolor="#d2c9ba" align="center" cellpadding="1" cellspacing="1" bgcolor="#eae3d9">
  <tr align="center" height="40">
    <td width="200" class="style1">帖子主题</td>
    <td width="400" class="style1">帖子内容</td>
    <td width="200" class="style1">发帖人</td>
    <td width="200" class="style1">操作</td>
  </tr>
<?php  
$query="select * from tb_czqtz";
$result=mysql_query($query);
...
?>
  <tr height="70">
    <td width="150" align="center" class="style1"><?php echo $myrow['title'];?></td>
    <td width="4s00" align="center" class="style1"><?php echo $myrow['content'];?></td>
  <td width="150" align="center" class="style1"><?php echo $myrow['username'];?></td>
    <td height="50" width="150" align="center" valign="middle" class="style1">&nbsp;<a href="adtzz_ok.php?tz_id=<?php echo $myrow['tz_id'];?>">删除</a></td>
  </tr>
...
?>
<div align="center" size="20">暂无用户信息！！！！</div>
<?php
}
?> 
